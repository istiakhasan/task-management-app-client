             ...
             <h1 className='text-3xl underline my-5 text-black font-semibold '>Completed Task List </h1>
                {
                    completedTodo.map(data=>(
                        <div key={data._id} className='flex bg-white mt-1 rounded-[8px] p-2 items-center justify-between'>
                                 <div className='flex items-center'>
                                 <InboxIcon className='w-6 h-6 mr-2 text-primary' />
                                 <li className='text-md  lg:w-[500px] w-[250px] h-auto p-2 text-black '>{data.todoDescription}</li>
                                 </div>
