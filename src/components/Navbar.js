...
setTodo([...todo,e.target.todo.value])
  ...
  <input name='todo' type="text" placeholder="Type here" class="input input-bordered input-primary w-full max-w-xs" />
  <button type='submit' className='btn btn-primary ml-8 text-white'>Add Task</button>
    </form>
  </div>
